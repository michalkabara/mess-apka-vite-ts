...
export const Footer = () => {
  return (
    <div>
      <div className="dark:bg-zinc-800 dark:text-zinc-100 bg-zinc-200 text-zinc-800 mt-10 m-auto">
      ...
      <div className=" bg-white dark:bg-zinc-950 text-zinc-800 dark:text-zinc-100">
