...
export const Footer = () => {
  return (
    <>
      <div className="bg-zinc-900 mt-10 m-auto">
        <div className="max-w-[1200px] w-full m-auto min-h-11 text-sm px-5 py-10 flex flex-row gap-10">
          <p>
      ...
      <div className="text-xs p-5 flex justify-between items-center max-w-[1200px] m-auto">
